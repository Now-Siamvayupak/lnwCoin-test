...
class _NewsFeedPageState extends State<NewsFeedPage>
  ...
  void initState() {
    ...
    _newsFuture = _newsService.getNews(); // Fetch data once
    _checkInternetConnection();
    super.initState();
  }
                      ...
                      if (snapshot.hasData) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            // Use null-aware operators to provide default values for each field
                            final String title = article['title'] ?? 'No title';
                            final String summary = article['description'] ??
                                'No summary available';
                            final String imageUrl = article['urlToImage'] ??
                                'https://example.com/default_image.png';
                            final String url = article['url'] ?? '#';

                            // Skip rendering if any essential data is effectively missing
                            if (title == 'No title' ||
                            ...
                            try {
                              ...
                              // If date parsing fails, also skip rendering
                              print(e);
                              return SizedBox.shrink();
                            }
